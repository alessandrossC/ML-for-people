...
def preprocess_train_data(
    ...
    transformers = []
    if scaler_numeric:
        transformers.append(("num_scale", MinMaxScaler(), numeric_cols))
    transformers.append(("cat_encode", encoder, categorical_cols))
    ...
    encoded_cat_cols = preprocessor.named_transformers_["cat_encode"].get_feature_names_out(categorical_cols).tolist()
    all_columns = numeric_cols + encoded_cat_cols if scaler_numeric else numeric_cols + categorical_cols
